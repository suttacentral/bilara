 ...
 */
export const set = (obj, prop, value) => {
 ...
 */
export const get = (obj, prop, value) => {
	prop = typeof prop === 'number' ? propToArray(prop.toString()) : typeof prop === 'string' ? propToArray(prop) : prop;
 ...
 */
export const merge = (obj, prop, val) => {
	const curVal = get(obj, prop);
...
export const getArrayIndex = (head, obj) => {
	if (head === '$end') {
